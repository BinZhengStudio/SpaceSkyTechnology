...
public class EntityTypeList {
	...
	public static final RegistryObject<EntityType<TestPlaneEntity>> TEST = ENTITY_TYPES.register("test", () -> EntityType.Builder.of(TestPlaneEntity::new, MobCategory.MISC).sized(9.0F, 9.0F).build("test"));
