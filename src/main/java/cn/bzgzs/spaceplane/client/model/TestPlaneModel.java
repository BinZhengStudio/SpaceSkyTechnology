...
public class TestPlaneModel extends EntityModel<TestPlaneEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(204, 170).addBox(-53.0F, -6.0F, -4.0F, 41.0F, 12.0F, 8.0F, new CubeDeformation(0.0F))
				...
				.texOffs(192, 0).addBox(11.0F, -3.0F, -13.0F, 26.0F, 11.0F, 26.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -21.0F, 0.0F, 0.0F, -1.5708F, -3.1416F));
		...
		PartDefinition cube_r2 = layer1.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(483, 495).addBox(7.0F, -8.0F, 10.0F, -14.0F, -5.0F, -1.0F, new CubeDeformation(0.0F))
				...
				.texOffs(500, 499).addBox(8.0F, -8.0F, 42.0F, -1.0F, -5.0F, -32.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.0F, 0.0F, 0.0F, 0.0F, -3.1416F));
		...
		PartDefinition cube_r3 = layer2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(172, 426).addBox(6.0F, -13.0F, 11.0F, -12.0F, -4.0F, 1.0F, new CubeDeformation(0.0F))
				...
				.texOffs(97, 454).addBox(-6.0F, -13.0F, 39.0F, -1.0F, -4.0F, -27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.0F, 0.0F, 0.0F, 0.0F, -3.1416F));
		...
		PartDefinition cube_r4 = rudder.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 96).addBox(-53.0F, -28.0F, -17.0F, 20.0F, 20.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(92, 112).addBox(-53.0F, -28.0F, 18.0F, 20.0F, 20.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.0F, 0.0F, 0.0F, -1.5708F, -3.1416F));
		...
		PartDefinition cube_r5 = leftWing.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(129, 141).addBox(-53.0F, -5.0F, 23.0F, 32.0F, 0.0F, 29.0F, new CubeDeformation(0.0F))
				.texOffs(76, 96).addBox(-5.0F, -5.0F, 23.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.0F, 0.0F, 0.0F, -1.5708F, -3.1416F));
		...
		PartDefinition cube_r6 = rightWing.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(112, 0).addBox(-5.0F, -5.0F, -39.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F))
				.texOffs(127, 96).addBox(-53.0F, -5.0F, -52.0F, 32.0F, 0.0F, 29.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, -1.0F, 27.0F, 0.0F, -1.5708F, -3.1416F));
		...
		PartDefinition cube_r7 = sit.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(0, 32).addBox(11.0F, -5.0F, -6.0F, 9.0F, 2.0F, 12.0F, new CubeDeformation(0.0F))
				.texOffs(128, 16).addBox(11.0F, -12.0F, -6.0F, 2.0F, 7.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -69.0F, 0.0F, 0.0F, -1.5708F, -3.1416F));
		...
		PartDefinition cube_r8 = head.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(0, 0).addBox(37.0F, -8.0F, -8.0F, 6.0F, 16.0F, 16.0F, new CubeDeformation(0.0F))
				...
				.texOffs(0, 0).addBox(54.0F, -2.0F, -2.0F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -69.0F, 0.0F, 0.0F, -1.5708F, -3.1416F));
		...
		PartDefinition cube_r9 = frontGear.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(20, 116).addBox(16.0F, 15.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(0, 116).addBox(18.0F, 8.0F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -61.0F, -20.0F, 0.0F, -1.5708F, -3.1416F));
		...
		PartDefinition cube_r10 = leftGear.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(22, 76).addBox(-27.0F, 15.0F, 7.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(36, 60).addBox(-25.0F, 8.0F, 9.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-10.0F, -61.0F, 23.0F, 0.0F, -1.5708F, -3.1416F));
		...
		PartDefinition cube_r11 = rightGear.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(22, 48).addBox(-27.0F, 15.0F, -13.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(0, 48).addBox(-25.0F, 8.0F, -11.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(10.0F, -61.0F, 23.0F, 0.0F, -1.5708F, -3.1416F));
		...
		PartDefinition cube_r12 = engine1.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(158, 170).addBox(-5.0F, -5.0F, -56.0F, 1.0F, 10.0F, 44.0F, new CubeDeformation(0.0F))
				...
				.texOffs(94, 141).addBox(-15.0F, 5.0F, -56.0F, 10.0F, 1.0F, 44.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -69.0F, 0.0F, 0.0F, 0.0F, -3.1416F));
		...
		PartDefinition cube_r13 = engine2.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(0, 158).addBox(15.0F, -5.0F, -56.0F, 1.0F, 10.0F, 44.0F, new CubeDeformation(0.0F))
				...
				.texOffs(128, 0).addBox(5.0F, 5.0F, -56.0F, 10.0F, 1.0F, 44.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -69.0F, 0.0F, 0.0F, 0.0F, -3.1416F));
		...
		PartDefinition mainRod = engineRod.addOrReplaceChild("mainRod", CubeListBuilder.create().texOffs(192, 45).addBox(-4.0F, -38.0F, -106.0F, 4.0F, 4.0F, 39.0F, new CubeDeformation(0.0F)), PartPose.offset(-8.0F, -33.0F, 55.0F));
		...
		PartDefinition cube_r14 = rodDecorate.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(0, 32).addBox(-8.7674F, 9.3948F, -26.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
				...
				.texOffs(30, 37).addBox(-8.7674F, 2.3948F, -44.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -69.0F, 0.0F, 0.0F, 0.0F, 0.7854F));
		...
		PartDefinition mainRod2 = engineRod2.addOrReplaceChild("mainRod2", CubeListBuilder.create().texOffs(181, 93).addBox(8.0F, -8.0F, -51.0F, 4.0F, 4.0F, 39.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -63.0F, 0.0F));
		...
		PartDefinition cube_r15 = rodDecorate2.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(0, 8).addBox(5.8284F, -4.6863F, -26.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
				...
				.texOffs(28, 10).addBox(5.8284F, -11.6863F, -44.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.0F, 0.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition engineDecorate = partdefinition.addOrReplaceChild("engineDecorate", CubeListBuilder.create().texOffs(128, 56).addBox(-11.5F, -65.0F, -49.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(128, 52).addBox(-11.5F, -74.0F, -17.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(128, 48).addBox(-11.5F, -74.0F, -35.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(128, 39).addBox(-11.5F, -74.0F, -49.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(135, 63).addBox(-15.0F, -70.5F, -17.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(37, 135).addBox(-15.0F, -70.5F, -35.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(124, 132).addBox(-6.0F, -70.5F, -17.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(116, 132).addBox(-6.0F, -70.5F, -49.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(108, 132).addBox(-6.0F, -70.5F, -35.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(100, 132).addBox(-15.0F, -70.5F, -49.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(128, 35).addBox(-11.5F, -65.0F, -17.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(32, 128).addBox(-11.5F, -65.0F, -35.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 56.0F, 0.0F));

		PartDefinition engineDecorate2 = partdefinition.addOrReplaceChild("engineDecorate2", CubeListBuilder.create().texOffs(124, 100).addBox(8.5F, -65.0F, -49.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(124, 96).addBox(8.5F, -74.0F, -17.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(34, 88).addBox(8.5F, -74.0F, -35.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(22, 88).addBox(8.5F, -74.0F, -49.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(92, 132).addBox(5.0F, -70.5F, -17.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(32, 132).addBox(5.0F, -70.5F, -35.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(128, 84).addBox(14.0F, -70.5F, -17.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(38, 113).addBox(14.0F, -70.5F, -49.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(0, 76).addBox(14.0F, -70.5F, -35.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(37, 2).addBox(5.0F, -70.5F, -49.0F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(14, 76).addBox(8.5F, -65.0F, -17.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(0, 57).addBox(8.5F, -65.0F, -35.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 56.0F, 0.0F));
	...
	public void landingGearRenderer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		landingGear.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
