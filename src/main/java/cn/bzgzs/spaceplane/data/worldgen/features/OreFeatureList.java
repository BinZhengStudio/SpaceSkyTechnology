...
public class OreFeatureList {
	...
	public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_RHENIUM = FeatureUtils.register("ore_rhenium", Feature.ORE, new OreConfiguration(ORE_RHENIUM_TARGET_LIST, 3));
